/**
 * Pure TypeScript implementation of the MD5 Message-Digest Algorithm (RFC 1321).
...
/**
 * Calculates the MD5 hash of a string and returns it as a lowercase hex string.
 */
